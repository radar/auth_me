...
module AuthMe
  class Application < Hanami::Application
    configure do
      ...
      #
      sessions :cookie, secret: ENV['AUTH_ME_SESSIONS_SECRET']
      ...
      #
      # layout :foo
      # layout :application # It will load AuthMe::Views::ApplicationLayout
      ...
      controller.prepare do
        include AuthMe::Controllers::Authentication # included in all the actions
      ...
      view.prepare do
        include AuthMe::Views::Authentication
